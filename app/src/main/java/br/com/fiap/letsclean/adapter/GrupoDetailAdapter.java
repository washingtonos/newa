...
public class GrupoDetailAdapter extends RecyclerView.Adapter<GrupoDetailAdapter.GrupoViewHolder>{

    private Context mContext;
    private List<Grupo> grupos = new ArrayList<>();

    public GrupoDetailAdapter(Context mContext, ArrayList<Grupo> grupos) {
