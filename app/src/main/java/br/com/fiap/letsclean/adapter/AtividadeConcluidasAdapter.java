...
public class AtividadeConcluidasAdapter extends RecyclerView.Adapter<AtividadeConcluidasAdapter.AtividadeViewHolder>{
    ...
    public AtividadeConcluidasAdapter(Context mContext, ArrayList<Atividade> atividades) {
    ...
    @NonNull
    @Override
    public AtividadeConcluidasAdapter.AtividadeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.list_atividade_concluidas_layout, parent,false);
        return new AtividadeConcluidasAdapter.AtividadeViewHolder(view ,mContext, (ArrayList<Atividade>) atividades);
    }

    @Override
    public void onBindViewHolder(@NonNull AtividadeConcluidasAdapter.AtividadeViewHolder holder, int position) {
